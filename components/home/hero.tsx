...
import HeroImg from '@/public/images/1200/bentto-56.webp'
		...
		<section className='relative lg:h-screen pt-40 md:pt-48 lg:pt-42  2xl:pt-36  mb-10 '>
			...
			<div className='wrapper h-full grid grid-cols-1 lg:grid-cols-2 gap-12 2xl:gap-16 '>
				...
				<div className='flex flex-col justify-center items-center lg:items-start text-center lg:text-left '>
					<h1 className='heading !text-[25px]  xxs:!text-3xl xs:!text-4xl xl:!text-5xl'>
				...
				<Image
					...
					priority
					className='sm:mb-24 lg:pb-20 lg:mb-0 mx-auto max-w-[600px] aspect-[4/3] lg:aspect-auto lg:h-3/4 xl:h-[100%] 2xl:h-[94%] w-full xl:w-[90%]  my-auto object-cover'
				/>
			</div>
		</section>
	)

...
const Hero = () => {
	return (
		<section className='pt-48 lg:pt-36 relative lg:h-screen mb-10 sm:mb-20'>
			...
			<div className='wrapper grid grid-cols-1 lg:grid-cols-2 h-full gap-12 2xl:gap-32 '>
				...
				<div className='flex flex-col justify-center items-center lg:items-start text-center lg:text-left '>
					<h1 className='heading !text-[25px]  xxs:!text-3xl xs:!text-4xl xl:!text-5xl'>Sprzęt gastronomiczny najwyższej jakości</h1>
					<p className=' md:text-xl leading-relaxed  mt-6'>
				...
				{/* image */}
				<Image src={HeroImg} alt='2' width={600} height={814} priority quality={90} className='sm:mb-24 lg:pb-20 lg:mb-0 mx-auto max-w-[600px] aspect-[4/3] lg:aspect-auto lg:h-3/4 xl:h-[84%] w-full xl:w-[90%]  my-auto' />
			</div>
		</section>
	)
}
